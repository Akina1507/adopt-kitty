...
<div class="container form-container">
    <div class="row justify-content-md-center">
        ...
        <button class="btn btn-primary fw-bold m-1" id="nextBtn3" onclick="nextPrev(1)" type="button">Next</button>
        ...
        <div class="d-flex btn-row">
        <button class="btn btn-primary fw-bold m-1" id="prevBtn" onclick="nextPrev(-1)" type="button">Previous</button>
        <button class="btn btn-primary fw-bold m-1" id="nextBtn4" onclick="nextPrev(1)" type="button">Next</button>
    </div>
    </div>
