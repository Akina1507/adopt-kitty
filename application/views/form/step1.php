            ...
            <form class="upe-mutistep-form" id="Upemultistepsform" action="<?= site_url('Famille2/step2'); ?>" method="post">
                ...
                <div class="step">
                    ...
                    <div class="d-flex btn-row">
                        <button class="btn btn-primary fw-bold m-1" id="suivBtn" type="button">Suivant</button>
                    </div>
                </div>
                <div class="step">
                    <div class="row">
                    ...
                    <div class="d-flex btn-row">
                        <button class="btn btn-primary fw-bold m-1" id="prevBtn" type="button">Précédent</button>
                        <button class="btn btn-primary fw-bold m-1" id="suivBtn" type="button">Suivant</button>
                    </div>
                </div>
                <div class="step">
