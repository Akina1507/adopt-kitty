...
class Famille1 extends CI_Controller
{
    ...
    public function announce()
    {
        ...
        $this->form_validation->set_rules('espece_animal', 'Espece', 'trim|required|valid_email|is_unique[famille.email_user]');
        ...
        $this->form_validation->set_rules('sexe_animal', 'Sexe', 'trim|required');
        $this->form_validation->set_rules('lieu_animal', 'Lieu', 'trim|required');
        $this->form_validation->set_rules('compatible_animal', 'Compatibilité', 'trim|required');
